...
const articles = [
  {
    ...
    content: [
      ...
      "From the moment he appears, Ulquiorra stands apart through his calm demeanor and relentless focus on his mission.",
    ],
  },
  {
    ...
    content: [
      ...
      "His second transformation, Segunda Etapa, reveals a darker and more devastating power than anyone expected.",
    ],
  },
  {
    ...
    content: [
      ...
      "This internal struggle becomes a defining part of his character, making him more tragic than a simple villain.",
    ],
  },
  {
    ...
    content: [
      ...
      "His most memorable line, \"What is a heart?\", captures his bewilderment and emerging curiosity.",
    ],
  },
  {
    ...
    content: [
      ...
      "Ulquiorra’s story continues to resonate as a symbol of the conflict between emptiness and emotion.",
    ],
  },
];
